...
//    @Rule public EphemeralFileSystemRule fs = new EphemeralFileSystemRule();
    ...
    public void setUpNeoStore() throws Exception
    {
        ...
        File file = file( NeoStore.DEFAULT_NAME );
        sf.createNeoStore( file ).close();
        neoStore = new FlatNeoStores( path.getCanonicalPath() + "/", config, new DefaultIdGeneratorFactory(), fs, StringLogger.SYSTEM );
    }
